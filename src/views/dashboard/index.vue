<template>
  <div class="dashboard-container">
    ...
    <el-dialog
      ...
      @close="btnCancel"
    >
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="25%">
        ...
        <el-form-item label="离职原因" prop="reason">
          <el-input v-model="ruleForm.reason" type="textarea" placeholder="请输入内容" style="width:80%" :autosize="{minRows:3,maxRows:8}" />
        </el-form-item>
      </el-form>
      <div slot="footer">
